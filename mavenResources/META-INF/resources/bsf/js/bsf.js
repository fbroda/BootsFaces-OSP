...
"'");opts[propertyName]=p}BsF.blockBlockUI=opts["blockui.disabled"]==="true";faces.ajax.request(source,event,opts);return false};
...
BsF.ajax.paginate=function(o,e,v,c,r){var opts={};opts.execute="@this";opts.render=r;opts[c]=v;faces.ajax.request(c,e,opts);return false};
